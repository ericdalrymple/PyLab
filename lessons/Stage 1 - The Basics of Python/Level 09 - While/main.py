# ==================================================== #
# ======= LESSON 9: Using 'while' Instructions ======= #
# ==================================================== #

# You can use the 'while' instruction to ask the computer to repeat the
# same instructions over and over again until something becomes 'False'.

# This is kind of like an 'if' instruction, but on repeat. Let's see how
# we can improve our guessing game by using the 'while' instruction.
...
# Now we can ask the player over and over until they get it right!
# We don't need to restart the program every time.
