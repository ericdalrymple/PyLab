...
<tileset version="1.10" tiledversion="1.11.2" name="cat_animation" tilewidth="16" tileheight="16" tilecount="216" columns="6">
 <image source="../tilemaps/cat_animation.png" width="96" height="576"/>
 <tile id="0">
  <animation>
